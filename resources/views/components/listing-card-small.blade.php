...
<a href="{{ route('properties.show', $listing->slug) }}" class="rounded-2xl overflow-hidden h-full flex flex-col items-center bg-white shadow hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 rounded-2xl">
