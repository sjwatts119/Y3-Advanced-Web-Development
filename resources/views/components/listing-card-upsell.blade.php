...
<a href="{{ route('properties.show', $listing->slug) }}" class="rounded-2xl overflow-hidden h-full flex flex-col items-center bg-white shadow-none transition-shadow duration-300 cursor-pointer hover:shadow-lg hover:shadow-gray-400 hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 rounded-2xl">
