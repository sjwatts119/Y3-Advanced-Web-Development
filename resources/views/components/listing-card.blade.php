...
<a href="{{ route('properties.show', $listing->slug) }}" class="h-full flex flex-col items-center bg-white shadow lg:flex-row transition hover:bg-gray-200 hover:shadow-lg dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
