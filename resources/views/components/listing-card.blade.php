...
<a href="{{ route('properties.show', $listing->slug) }}" class="h-full flex flex-col items-center bg-white shadow lg:flex-row hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
