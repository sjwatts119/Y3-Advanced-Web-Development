<div class="container md:min-h-0 flex flex-col p-4 leading-normal">
    ...
    @elseif(count($listing->getMedia()) == 1)
        <div class="relative w-full">
            <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                <img src="{{$listing->getFirstMediaUrl()}}" class="object-cover absolute block w-full h-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            </div>
        </div>
    @else
        <div class="relative w-full">
            <div class="relative h-56 overflow-hidden rounded-lg md:h-96">
                <img src="https://placehold.co/400" class="object-cover absolute block w-full h-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2" alt="...">
            </div>
        </div>
    @endif
</div>
