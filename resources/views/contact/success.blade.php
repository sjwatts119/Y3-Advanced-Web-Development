<x-guest-layout>
    ...
    <div class="flex items-center justify-center w-full">
        <div class="rounded-xl bg-white p-8">
            <h1 class="text-2xl font-bold text-center text-gray-900 dark:text-white">Message Sent Successfully</h1>
            <p class="text-center text-gray-700 dark:text-gray-400">Thank you for contacting us. We will be in touch shortly.</p>
        </div>
    </div>
