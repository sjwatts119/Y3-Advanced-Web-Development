        ...
        <section class="h-screen flex flex-col items-center justify-center text-center text-white ">
            ...
            <div class="video-content space-y-2 z-10">
                <div class="flex flex-col justify-between">
                    <div class="py-12 px-4 mx-auto max-w-screen-xl text-center pb-60">
                        <h1 class="mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl lg:text-6xl text-white hover:scale-110 transition-transform duration-200">Welcome to {{$theme->company_name}}</h1>
                        <p class="mb-8 text-lg font-normal text-gray-200 lg:text-xl sm:px-16 lg:px-48">We provide premium holiday cottages and unique converted buildings for a memorable stay. Explore our portfolio that includes a castle, a converted lighthouse, and a WWII military base.</p>
...
{{--put the jumbotron inside the header--}}
    ...
    <section class="w-full bg-gray-100 pb-20 pt-10">
    ...
    <section class="w-full bg-gradient-to-l from-blue-50 to-pink-50 pb-20 pt-10">
        {{--why us?--}}
        <div class="py-12 px-4 mx-auto max-w-screen-xl">
